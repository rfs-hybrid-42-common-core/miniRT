...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/13 16:36:28 by maaugust          #+#    #+#             */
/*   Updated: 2026/06/29 21:28:18 by maaugust         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @fn t_tuple apply_cone_tbn(t_computations *comps, t_tuple map_normal)
 * @brief Applies a normal map to a Cone using a TBN matrix.
 * @details Evaluates the local Up and Right vectors cross products to 
 * dynamically wrap the Tangent Space around the slanted cone walls and 
 * flat caps.
